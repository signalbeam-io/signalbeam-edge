        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var body = $"""
            ...
            <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <p><strong>{inviterName}</strong> has invited you to join <strong>{tenantName}</strong> on SignalBeam Edge.</p>
                <p>Click the link below to accept the invitation:</p>
                <p><a href="{acceptUrl}" style="display: inline-block; padding: 12px 24px; background-color: #7c3aed; color: white; text-decoration: none; border-radius: 6px;">Accept Invitation</a></p>
